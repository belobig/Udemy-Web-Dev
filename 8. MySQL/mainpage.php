  ...
  <body data-spy="scroll" data-target=".navbar-collapse"> <!-- This is needed for scroll spy. Data-target is name of class you want to spy -->
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div class="pull-right"> <!-- This is the class being spied -->
				<ul class="navbar-nav nav">
					<li><a href="kellysdiary.php?logout=1">Log Out</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container contentContainer" id="topContainer">
		<div class="row">
			<div class="col-md-6 col-md-offset-3" id="topRow">
				<textarea class="form-control"><?php echo $diary; a?></textarea>
			</div>
		</div>
	</div>
